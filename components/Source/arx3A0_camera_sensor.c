...
extern ARM_DRIVER_GPIO ARM_Driver_GPIO_(RTE_ARX3A0_CAMERA_RESET_GPIO_PORT);
static ARM_DRIVER_GPIO *GPIO_Driver_CAM = &ARM_Driver_GPIO_(RTE_ARX3A0_CAMERA_RESET_GPIO_PORT);
...
{
#if RTE_CPI
    set_cpi_pixel_clk(CPI_PIX_CLKSEL_400MZ, RTE_ARX3A0_CAMERA_SENSOR_CPI_CLK_SCR_DIV);
#endif
#if RTE_LPCPI
    set_lpcpi_pixel_clk(RTE_ARX3A0_CAMERA_SENSOR_LPCPI_CLK_SCR_DIV);
#endif
}
...
/**
  ...
  */
static CAMERA_SENSOR_CONFIG cpi_arx3a0_config =
{
    .interface    = CPI_INTERFACE_MIPI_CSI,
    .vsync_wait   = RTE_ARX3A0_CAMERA_SENSOR_CPI_VSYNC_WAIT,
    .vsync_mode   = RTE_ARX3A0_CAMERA_SENSOR_CPI_VSYNC_MODE,
    .pixelclk_pol = RTE_ARX3A0_CAMERA_SENSOR_CPI_PIXEL_CLK_POL,
    .hsync_pol    = RTE_ARX3A0_CAMERA_SENSOR_CPI_HSYNC_POL,
    .vsync_pol    = RTE_ARX3A0_CAMERA_SENSOR_CPI_VSYNC_POL,
    .data_mode    = RTE_ARX3A0_CAMERA_SENSOR_CPI_DATA_MODE,
    .data_field   = RTE_ARX3A0_CAMERA_SENSOR_CPI_MSB,
    .code10on8    = RTE_ARX3A0_CAMERA_SENSOR_CPI_CODE10ON8,
    .data_mask    = RTE_ARX3A0_CAMERA_SENSOR_CPI_DATA_MASK,
};
...
CAMERA_SENSOR_DEVICE cpi_arx3a0_camera_sensor =
{
    .Info    = &arx3a0_info,
    .Config  = &cpi_arx3a0_config,
    .Ops     = &arx3a0_ops,
};
