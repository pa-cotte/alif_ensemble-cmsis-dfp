 ...
 * @note
 */
#if   CPU == CPU_M55_HE || defined(M55_HE)
#define DTCM_GLOBAL_ADDRESS         HE_DTCM_GLOBAL_ADDRESS
#elif CPU == CPU_M55_HP || defined(M55_HP)
#define DTCM_GLOBAL_ADDRESS         HP_DTCM_GLOBAL_ADDRESS
#elif CPU == A32
// .global_offset         = DTCM_GLOBAL_ADDRESS - M55_DTCM_LOCAL_OFFSET = 0
#define DTCM_GLOBAL_ADDRESS         M55_DTCM_LOCAL_OFFSET
#else
