...
/* PINMUX Driver */
//#include "Driver_PINMUX_AND_PINPAD.h" //todo
//#include "pinmux_def.h" //todo

#include "pinconf.h" //todo our driver
...
#if 0 //todo B0 PinMux
	//	*uart6_rx_B_pinmux = 0x1;
	//	*uart6_tx_B_pinmux = 0x1;
		WR_PINMUX_UART4_TX_C(1);
		WR_PINMUX_UART4_RX_C(0);

		WR_PINMUX_UART6_RX_B(1);
		WR_PINMUX_UART6_TX_B(0);
		WR_PINMUX_UART7_RX_B(1);
		WR_PINMUX_UART7_TX_B(0);
#endif

#if 1 //todo new pinmux driver
	//pinconf_set(const uint8_t port, const uint8_t pin, const uint8_t alt_func, const uint8_t pad_ctrl);

		//RX
		//WR_PINMUX_UART4_RX_C(0);
		pinconf_set( PORT_5,  PIN_0,  PINMUX_ALTERNATE_FUNCTION_2,  0);

		//TX
		//WR_PINMUX_UART4_TX_C(1);
		pinconf_set( PORT_5,  PIN_1,  PINMUX_ALTERNATE_FUNCTION_2,  1);
